...
public class DuelLeaderboards extends BaseCommand {
	@Default
	@CommandPermission("practice.leaderboards")
	public void leaderboards(final CommandSender sender) {
		...
		final Selection selection = new Selection((Player) sender, Goal.LEADERBOARDS);
